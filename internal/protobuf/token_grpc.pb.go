...
type TokenClient interface {
	...
	DestroyToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*DestroyStatus, error)
}
...
func (c *tokenClient) DestroyToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*DestroyStatus, error) {
	out := new(DestroyStatus)
	err := c.cc.Invoke(ctx, "/Token/DestroyToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TokenServer interface {
	...
	// destroy opaque token
	DestroyToken(context.Context, *TokenRequest) (*DestroyStatus, error)
...
func (UnimplementedTokenServer) DestroyToken(context.Context, *TokenRequest) (*DestroyStatus, error) {
...
func _Token_DestroyToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TokenServer).DestroyToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Token/DestroyToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenServer).DestroyToken(ctx, req.(*TokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Token_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Token_DestroyToken_Handler,
		},
	},
